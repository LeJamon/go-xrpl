// Package schema is the declarative source of truth for the per-entry-type
// typed metadata decoders generated under ledger/entry. Each
...
// for fields that diverge from the sMD_Default rule. cmd/entrygen
...
// Serialization styles used by ledger-entry fields.
const (
