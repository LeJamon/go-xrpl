...
func (x *XChainOwnedClaimID) Type() Type {
	return TypeXChainOwnedClaimID
}
...
func (x *XChainOwnedCreateAccountClaimID) Type() Type {
	return TypeXChainOwnedCreateAccountClaimID
}
