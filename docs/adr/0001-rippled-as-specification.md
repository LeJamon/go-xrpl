...
Treat rippled as the de facto specification. The correctness bar for any goXRPL
...
- goXRPL inherits rippled's quirks where they are consensus-relevant; "the spec"
