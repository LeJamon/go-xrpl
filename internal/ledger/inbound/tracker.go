...
func acquisitionDiagnosticsJSON(snap Snapshot) map[string]any {
	...
	diagnostics := map[string]any{
		...
		"persistence_capacity_bytes":      d.Persistence.CapacityBytes,
		"persistence_pending_bytes":       d.Persistence.PendingBytes,
		"persistence_current_bytes":       d.Persistence.CurrentBytes,
		"persistence_peak_bytes":          d.Persistence.PeakBytes,
		"persistence_queue_waits_total":   d.Persistence.QueueWaits,
		"persistence_queue_wait_ms_total": d.Persistence.QueueWait.Milliseconds(),
		"persistence_entries_written":     d.Persistence.EntriesWritten,
		"persistence_bytes_written":       d.Persistence.BytesWritten,
		"persistence_store_ms_total":      d.Persistence.StoreLatency.Milliseconds(),
		"persistence_failures_total":      d.Persistence.StoreFailures,
	}
