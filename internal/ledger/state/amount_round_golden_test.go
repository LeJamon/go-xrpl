...
// reachable in a valid ledger; they differ only on operand pairs whose product
// would exceed 10^17 drops, where MulRoundNative/DivRoundNative now scale a
// positive residual offset like the offer and payment native paths (and like
// rippled) instead of silently dropping it. Such amounts cannot occur on chain.
