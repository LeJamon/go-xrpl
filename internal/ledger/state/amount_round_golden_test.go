...
// reachable in a valid ledger; they differ only on operand pairs that cannot
// occur on chain: those whose product would exceed 10^17 drops, where
// MulRoundNative/DivRoundNative now scale a positive residual offset like the
// offer and payment native paths (and like rippled) instead of silently dropping
// it; and native×native multiplies, which take rippled's mulRoundImpl fast path
// and so panic ("Native value overflow") for a negative or oversized operand
// (pair [8 6]) rather than routing through the generic mantissa path.
func amountRoundGoldens() []string {
	return []string{
		"|ru=false MS=IOU(m=3333333333333333,e=13,neg=false,zero=false) M=IOU(m=3333333333333333,e=13,neg=false,zero=false) D=IOU(m=3000000000000000,e=-14,neg=false,zero=false) DS=IOU(m=3000000000000000,e=-14,neg=false,zero=false) DN=30 MN=-3520120672398401536|ru=true MS=IOU(m=3333333333333333,e=13,neg=false,zero=false) M=IOU(m=3333333333333333,e=13,neg=false,zero=false) D=IOU(m=3000000000000001,e=-14,neg=false,zero=false) DS=IOU(m=3000000000000001,e=-14,neg=false,zero=false) DN=30 MN=-3520120672398401536",
		"|ru=false MS=IOU(m=3333333333333333,e=13,neg=false,zero=false) M=IOU(m=3333333333333333,e=13,neg=false,zero=false) D=IOU(m=3333333333333333,e=-17,neg=false,zero=false) DS=IOU(m=3333333333333333,e=-17,neg=false,zero=false) DN=0 MN=-3520120672398401536|ru=true MS=IOU(m=3333333333333333,e=13,neg=false,zero=false) M=IOU(m=3333333333333333,e=13,neg=false,zero=false) D=IOU(m=3333333333333333,e=-17,neg=false,zero=false) DS=IOU(m=3333333333333333,e=-17,neg=false,zero=false) DN=1 MN=-3520120672398401536",
		"|ru=false MS=IOU(m=7000000000000000,e=20,neg=false,zero=false) M=IOU(m=7000000000000000,e=20,neg=false,zero=false) D=IOU(m=1428571428571428,e=-21,neg=false,zero=false) DS=IOU(m=1428571428571428,e=-21,neg=false,zero=false) DN=0 MN=3509693170864619520|ru=true MS=IOU(m=7000000000000000,e=20,neg=false,zero=false) M=IOU(m=7000000000000000,e=20,neg=false,zero=false) D=IOU(m=1428571428571429,e=-21,neg=false,zero=false) DS=IOU(m=1428571428571429,e=-21,neg=false,zero=false) DN=1 MN=3509693170864619520",
		"|ru=false MS=IOU(m=-1750000000000000,e=11,neg=true,zero=false) M=IOU(m=-1750000000000000,e=11,neg=true,zero=false) D=IOU(m=-2800000000000000,e=0,neg=true,zero=false) DS=IOU(m=-2800000000000000,e=0,neg=true,zero=false) DN=-2800000000000001 MN=-170598510725431296|ru=true MS=IOU(m=-1750000000000000,e=11,neg=true,zero=false) M=IOU(m=-1750000000000000,e=11,neg=true,zero=false) D=IOU(m=-2800000000000000,e=0,neg=true,zero=false) DS=IOU(m=-2800000000000000,e=0,neg=true,zero=false) DN=-2800000000000000 MN=-170598510725431296",
		"|ru=false MS=IOU(m=-8333333333333333,e=3,neg=true,zero=false) M=IOU(m=-8333333333333333,e=3,neg=true,zero=false) D=IOU(m=-7500000000000001,e=-24,neg=true,zero=false) DS=IOU(m=-7500000000000001,e=-24,neg=true,zero=false) DN=0 MN=-8333333333333332500|ru=true MS=IOU(m=-8333333333333332,e=3,neg=true,zero=false) M=IOU(m=-8333333333333332,e=3,neg=true,zero=false) D=IOU(m=-7500000000000000,e=-24,neg=true,zero=false) DS=IOU(m=-7500000000000000,e=-24,neg=true,zero=false) DN=0 MN=-8333333333333332500",
		"|ru=false MS=PANIC(IOUAmount overflow) M=PANIC(IOUAmount overflow) D=IOU(m=9999999999999999,e=65,neg=false,zero=false) DS=IOU(m=9999999999999999,e=65,neg=false,zero=false) DN=0 MN=0|ru=true MS=PANIC(IOUAmount overflow) M=PANIC(IOUAmount overflow) D=IOU(m=9999999999999999,e=65,neg=false,zero=false) DS=IOU(m=9999999999999999,e=65,neg=false,zero=false) DN=1 MN=1",
		...
		"|ru=false MS=IOU(m=1000000000000000,e=6,neg=false,zero=false) M=IOU(m=1000000000000000,e=6,neg=false,zero=false) D=IOU(m=1000000000000000,e=-6,neg=false,zero=false) DS=IOU(m=1000000000000000,e=-6,neg=false,zero=false) DN=1000000000 MN=3875820019684212736|ru=true MS=IOU(m=1000000000000000,e=6,neg=false,zero=false) M=IOU(m=1000000000000000,e=6,neg=false,zero=false) D=IOU(m=1000000000000000,e=-6,neg=false,zero=false) DS=IOU(m=1000000000000000,e=-6,neg=false,zero=false) DN=1000000000 MN=3875820019684212736",
		"|ru=false MS=IOU(m=1000000000000000,e=6,neg=false,zero=false) M=IOU(m=1000000000000000,e=6,neg=false,zero=false) D=IOU(m=1000000000000000,e=-24,neg=false,zero=false) DS=IOU(m=1000000000000000,e=-24,neg=false,zero=false) DN=0 MN=3875820019684212736|ru=true MS=IOU(m=1000000000000000,e=6,neg=false,zero=false) M=IOU(m=1000000000000000,e=6,neg=false,zero=false) D=IOU(m=1000000000000000,e=-24,neg=false,zero=false) DS=IOU(m=1000000000000000,e=-24,neg=false,zero=false) DN=1 MN=3875820019684212736",
		...
		"|ru=false MS=IOU(m=7000000000000000,e=16,neg=false,zero=false) M=IOU(m=7000000000000000,e=16,neg=false,zero=false) D=IOU(m=7000000000000000,e=-6,neg=false,zero=false) DS=IOU(m=7000000000000000,e=-6,neg=false,zero=false) DN=7000000000 MN=4897961520886972416|ru=true MS=IOU(m=7000000000000000,e=16,neg=false,zero=false) M=IOU(m=7000000000000000,e=16,neg=false,zero=false) D=IOU(m=7000000000000000,e=-6,neg=false,zero=false) DS=IOU(m=7000000000000000,e=-6,neg=false,zero=false) DN=7000000000 MN=4897961520886972416",
	}
}
