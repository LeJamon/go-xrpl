...
var (
	...
	ErrVaultKindInvalid        = ter.Errorf(ter.TemMALFORMED, "invalid vault kind")
	ErrVaultDatesRequired      = ter.Errorf(ter.TemMALFORMED, "closed-ended vault requires SubscriptionDate and RedemptionDate")
	ErrVaultDatesForbidden     = ter.Errorf(ter.TemMALFORMED, "open-ended vault cannot specify SubscriptionDate or RedemptionDate")
	ErrVaultDatesInvalid       = ter.Errorf(ter.TemMALFORMED, "invalid closed-ended vault date range")
	ErrVaultLifecycleImmutable = ter.Errorf(ter.TemMALFORMED, "vault kind and lifecycle dates are immutable")
)
