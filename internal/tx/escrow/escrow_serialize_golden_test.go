...
// TestEscrowSerialize_OldNewByteIdentity proves state.SerializeEscrow reproduces
// the package-local serializeEscrow bytes for XRP, IOU, and MPT escrows across
// every optional field.
func TestEscrowSerialize_OldNewByteIdentity(t *testing.T) {
	...
	cases := []struct {
		...
		{name: "xrp_minimal", tx: xrpMin, ownerNd: 3, hasDest: false,
			wantHex: "1100752200000000202529B927003400000000000000036140000000000F424081140102030405060708090A0B0C0D0E0F10111213148314A1A2A3A4A5A6A7A8A9AAABACADAEAFB0B1B2B3B4"},
		{name: "xrp_full_seq", tx: xrpFull, ownerNd: 1, destNd: 2, hasDest: true, includeSeq: true,
			wantHex: ""},
		{name: "iou_with_transferrate", tx: iouEsc, rate: 1_005_000_000, ownerNd: 4, destNd: 5, hasDest: true, issuerNd: 6, hasIssuer: true,
			wantHex: ""},
		{name: "iou_parity_rate_omitted", tx: iouEsc, rate: 1_000_000_000, ownerNd: 4, destNd: 5, hasDest: true,
			wantHex: "1100752200000000202529B9270034000000000000000439000000000000000561D503920ACBFFD0000000000000000000000000005553440000000000B5F762798A53D543A014CAF8B297CFF8F2F937E881140102030405060708090A0B0C0D0E0F10111213148314A1A2A3A4A5A6A7A8A9AAABACADAEAFB0B1B2B3B4"},
		{name: "mpt_escrow", tx: mptEsc, ownerNd: 8, destNd: 9, hasDest: true,
			wantHex: "1100752200000000202429B927C83400000000000000083900000000000000096160000000000001E24000000539C35BFC42B69F7A19B7C4C5B5D5E7F9A1B3C5D7E981140102030405060708090A0B0C0D0E0F10111213148314A1A2A3A4A5A6A7A8A9AAABACADAEAFB0B1B2B3B4"},
	}
