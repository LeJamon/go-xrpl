...
func checkGoldenCases(t *testing.T) []checkGoldenCase {
	...
	return []checkGoldenCase{
		{name: "xrp_minimal", tx: &CheckCreate{}, sendMax: state.NewXRPAmountFromInt(1000000), ownerNd: 3, destNd: 5, hasDest: true,
			wantHex: "110043220000000024000000373400000000000000033900000000000000056940000000000F424081140102030405060708090A0B0C0D0E0F10111213148314A1A2A3A4A5A6A7A8A9AAABACADAEAFB0B1B2B3B4"},
		{name: "xrp_selfsend", tx: &CheckCreate{}, sendMax: state.NewXRPAmountFromInt(2500000), ownerNd: 0, destNd: 0, hasDest: false,
			wantHex: "110043220000000024000000373400000000000000003900000000000000006940000000002625A081140102030405060708090A0B0C0D0E0F10111213148314A1A2A3A4A5A6A7A8A9AAABACADAEAFB0B1B2B3B4"},
		{name: "xrp_tags_exp", tx: withExp, sendMax: state.NewXRPAmountFromInt(9999), ownerNd: 1, destNd: 2, hasDest: true,
			wantHex: "1100432200000000230000002A24000000372A29B9270034000000000000000139000000000000000269400000000000270F81140102030405060708090A0B0C0D0E0F10111213148314A1A2A3A4A5A6A7A8A9AAABACADAEAFB0B1B2B3B4"},
		{name: "iou_full", tx: full, sendMax: iou, ownerNd: 7, destNd: 11, hasDest: true,
			wantHex: ""},
	}
}
...
// captured from the pre-refactor path (serializeCheck → ParseCheck →
// SerializeCheckFromData) and proven byte-identical; any change is a state fork.
