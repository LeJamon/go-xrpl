...
const (
	...
	RpcNOT_ENABLED   = 12
	RpcNOT_SUPPORTED = 75
	// RpcNOT_READY matches rippled rpcNOT_READY = 13, token "notReady".
	// Returned by can_delete when "now" is requested before any ledger
	// has been rotated (getLastRotated() == 0).
	RpcNOT_READY = 13
