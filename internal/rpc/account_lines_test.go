...
func (m *mockAccountLinesLedgerService) GetBookOffers(_ context.Context, takerGets, takerPays types.Amount, _, _ string, ledgerIndex string, limit uint32, _ bool) (*types.BookOffersResult, error) {
	return nil, errors.New("not implemented")
}
