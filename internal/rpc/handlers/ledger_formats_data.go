...
// ledgerFormatField is one entry in a ledger-entry SOTemplate for the
// server_definitions LEDGER_ENTRY_FORMATS section. Style is the rippled
// SOEStyle int (0=required, 1=optional, 2=default).
type ledgerFormatField struct {
	Name  string
	Style int
}

// ledgerCommonFields mirrors rippled LedgerFormats::getCommonFields().
var ledgerCommonFields = []ledgerFormatField{
	{"LedgerIndex", 1},
	{"LedgerEntryType", 0},
	{"Flags", 0},
	{"Sponsor", 1},
