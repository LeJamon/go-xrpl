...
- Open follow-ups (Minor/Nit, non-gating, surfaced in the PR comment): M1 explicit-0 TxQ keys; M2 fetch_depth default sentinel; M3 align sqlite temp_store default to rippled `file` (separate behavioural change — flips TestDefaultSettingsUnchanged); M4 docs/operating.md still lists removed keys; N1 startup.go "clamps" comment.
