...
var (
	...
	FeatureFixDisallowIncomingV1       = registerRetired("fixDisallowIncomingV1")
	FeatureFixInnerObjTemplate         = registerRetired("fixInnerObjTemplate")
	...
	FeatureFixNFTokenReserve           = registerRetired("fixNFTokenReserve")
